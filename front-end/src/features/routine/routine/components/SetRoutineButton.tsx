...
import type { Task } from '@/features/routine/task/types/task.domain.type';
import { useEditMode } from '@/context/EditModeContext';
import { CloseButton } from '@/components/ui/Buttons/CloseButton';
import { useDeleteRoutine } from '@/features/routine/routine/hooks/useRoutine';
import { RoutineControls } from '@/features/routine/routine/components/RoutineControls';
    ...
    >
      <div
        className={cn(
          ...
          isActive
            ? 'border-surface2 bg-surface text-ink hover:text-ink/80 font-bold'
            : 'bg-surface/50 text-muted/50 hover:text-muted/80 font-medium',
        )}
      >
